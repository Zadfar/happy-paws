...
const PostModal = ({ active, handleModal, token, id, setErrorMessage }) => {
  ...
  return (
    <div className={`fixed inset-0 overflow-y-auto ${active ? 'block' : 'hidden'}`}>
      <div className="flex items-center justify-center min-h-screen">
        <div className="bg-white rounded-lg shadow-lg w-full max-w-md p-6">
          ...
          <div className="flex justify-end">
            {id ? (
              <button className="mr-2 bg-blue-500 text-white px-4 py-2 rounded-lg" onClick={handleUpdatePost}>
                Update
              </button>
            ) : (
              <button className="mr-2 bg-blue-500 text-white px-4 py-2 rounded-lg" onClick={handleCreatePost}>
                Create
              </button>
            )}
            <button className="bg-gray-300 px-4 py-2 rounded-lg" onClick={handleModal}>
              Cancel
            </button>
          </div>
        </div>
